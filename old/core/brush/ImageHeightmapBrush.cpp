...
namespace we {
ImageHeightmapBrush::ImageHeightmapBrush(
    unsigned short   s,
    int              a,
    Texture2D const& tex,
    bool             r
            ...
            if (posk.y > originY) {
                ...
                for (int i = originY + 1; i <= posk.y; ++i) {
                    ...
                    maskFunc(f, variables, [&]() mutable {
                        iter +=
                            playerData
                                .setBlockSimple(blockSource, f, variables, iPos, block);
                    });
                }
                ...
                for (int i = posk.y; i <= originY; ++i) {
                    ...
                    maskFunc(f, variables, [&]() mutable {
                        iter +=
                            playerData.setBlockSimple(blockSource, f, variables, iPos);
                    });
                }
            }
        }
