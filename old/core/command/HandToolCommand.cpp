 ...
 // {"cycler", {"cycler"}},
        ...
        [](DynamicCommand const&                                    command,
           ...
           std::unordered_map<std::string, DynamicCommand::Result>& results) {
            ...
            //     playerData.brushMap[toolName] = std::make_unique<TreeTool>
            //     (TreeTool()); output.trSuccess("worldedit.tool.set.tree", toolrName);
            // } else if (results["deltree"].isSet) {
            //     playerData.brushMap[toolName] = std::make_unique<DelTreeTool>
            //     (DelTreeTool()); output.trSuccess("worldedit.tool.set.deltree",
            //     toolrName);
            // } else
